...
In this post, I would like to share with you my experience in creating a simple chatbot model using Python and apply it in my project, [Corgiman](https://github.com/Linhvjc/Corgiman.git). I believe that this will provide valuable insight into the process of creating a chatbot and the challenges that come with it.
